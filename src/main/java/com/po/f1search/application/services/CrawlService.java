...
public class CrawlService implements CrawlUseCase {
    ...
    private boolean _isCrawling = false;
    ...
    public void crawl() {
        ...
        while (numberOfWebRessource < this.crawlconfig.getMaxCrawlingDepth() && this._isCrawling) {
    ...
    public void stopCrawl() {
        log.info("Crawling process stopped by user.");
        this._isCrawling = false;
    }
